...
public void createGUI(){
  ...
  X_Spacing = new GCustomSlider(ArrGUI, 154, 16, 113, 40, "grey_blue");
  ...
  Y_Spacing = new GCustomSlider(ArrGUI, 154, 44, 112, 40, "grey_blue");
  ...
  Spacing_Labels = new GLabel(ArrGUI, 130, 2, 80, 20);
  Spacing_Labels.setText("Spacing");
  Spacing_Labels.setOpaque(false);
  SizeSliders = new GLabel(ArrGUI, 129, 89, 123, 20);
  SizeSliders.setText("Tile Size");
  SizeSliders.setOpaque(false);
  arrwidthslider = new GCustomSlider(ArrGUI, 171, 107, 96, 40, "grey_blue");
  ...
  arrheightslider = new GCustomSlider(ArrGUI, 170, 142, 97, 40, "grey_blue");
  ...
  label13 = new GLabel(ArrGUI, 129, 25, 23, 20);
  label13.setText("X");
  label13.setOpaque(false);
  label14 = new GLabel(ArrGUI, 129, 53, 19, 17);
  label14.setText("Y");
  label14.setOpaque(false);
  label15 = new GLabel(ArrGUI, 129, 117, 47, 20);
  label15.setText("Width");
  label15.setOpaque(false);
  label16 = new GLabel(ArrGUI, 128, 146, 41, 20);
