...
public void createGUI(){
  ...
  label1 = new GLabel(gui, 109, 8, 80, 20);
  label1.setText("Colour Sliders");
  label1.setOpaque(false);
  greenSlider = new GCustomSlider(gui, 129, 58, 100, 40, "grey_blue");
  ...
  blueSlider = new GCustomSlider(gui, 129, 89, 100, 40, "grey_blue");
  ...
  redSlider = new GCustomSlider(gui, 129, 28, 100, 40, "grey_blue");
  ...
  heightSlider = new GCustomSlider(gui, 281, 57, 100, 40, "grey_blue");
  ...
  label2 = new GLabel(gui, 236, 6, 80, 20);
  label2.setText("Size Sliders");
  label2.setOpaque(false);
  gridButton = new GCheckbox(gui, 239, 185, 120, 21);
  ...
  autoAlign = new GCheckbox(gui, 238, 164, 120, 20);
  ...
  label3 = new GLabel(gui, 108, 128, 112, 29);
  label3.setText("Background Colour");
  label3.setOpaque(false);
  bgRedSlider = new GCustomSlider(gui, 129, 156, 100, 40, "grey_blue");
  ...
  bgGreenSlider = new GCustomSlider(gui, 129, 184, 100, 40, "grey_blue");
  ...
  bgBlueSlider = new GCustomSlider(gui, 129, 211, 100, 40, "grey_blue");
  ...
  fwdShapeButton = new GButton(gui, 238, 95, 143, 30);
  ...
  bwkShapeButton = new GButton(gui, 239, 131, 142, 30);
  ...
  label4 = new GLabel(gui, 108, 36, 20, 20);
  label4.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label4.setText("R");
  label4.setOpaque(false);
  label5 = new GLabel(gui, 109, 65, 20, 20);
  label5.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label5.setText("G");
  label5.setOpaque(false);
  label6 = new GLabel(gui, 110, 94, 20, 20);
  ...
  aguiback = new GButton(ArrGUI, 10, 151, 95, 30);
  ...
  X_Spacing = new GCustomSlider(ArrGUI, 154, 23, 100, 40, "grey_blue");
  ...
  Y_Spacing = new GCustomSlider(ArrGUI, 155, 51, 100, 40, "grey_blue");
  ...
  Spacing_Labels = new GLabel(ArrGUI, 132, 3, 80, 20);
  Spacing_Labels.setText("Spacing");
  Spacing_Labels.setOpaque(false);
  SizeSliders = new GLabel(ArrGUI, 126, 90, 123, 20);
  SizeSliders.setText("Tile Size");
  SizeSliders.setOpaque(false);
  arrwidthslider = new GCustomSlider(ArrGUI, 173, 111, 100, 40, "grey_blue");
  ...
  arrheightslider = new GCustomSlider(ArrGUI, 173, 139, 100, 40, "grey_blue");
  ...
  label13 = new GLabel(ArrGUI, 127, 33, 23, 20);
  label13.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label13.setText("X");
  label13.setOpaque(false);
  label14 = new GLabel(ArrGUI, 127, 58, 24, 20);
  label14.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label14.setText("Y");
  label14.setOpaque(false);
  label15 = new GLabel(ArrGUI, 125, 119, 45, 20);
  label15.setText("Width");
  label15.setOpaque(false);
  label16 = new GLabel(ArrGUI, 124, 147, 45, 20);
