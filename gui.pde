...
public void createGUI(){
  ...
  X_Spacing = new GCustomSlider(ArrGUI, 149, 23, 100, 40, "grey_blue");
  X_Spacing.setShowValue(true);
  X_Spacing.setLimits(50.0, 0.0, 500.0);
  X_Spacing.setNumberFormat(G4P.GREEN_SCHEME, 1);
  ...
  Y_Spacing = new GCustomSlider(ArrGUI, 149, 45, 100, 40, "grey_blue");
  ...
  Spacing_Labels = new GLabel(ArrGUI, 133, 3, 80, 20);
  ...
  arrwidthslider = new GCustomSlider(ArrGUI, 160, 109, 100, 40, "grey_blue");
  ...
  arrheightslider = new GCustomSlider(ArrGUI, 161, 138, 100, 40, "grey_blue");
  ...
  label13 = new GLabel(ArrGUI, 125, 33, 27, 19);
  label13.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label13.setText("X");
  label13.setOpaque(false);
  label14 = new GLabel(ArrGUI, 132, 57, 21, 18);
  label14.setText("Y");
  label14.setOpaque(false);
  label15 = new GLabel(ArrGUI, 100, 117, 80, 20);
  label15.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label15.setText("Width");
  label15.setOpaque(false);
  label16 = new GLabel(ArrGUI, 102, 147, 80, 20);
