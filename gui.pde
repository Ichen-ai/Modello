...
public void createGUI(){
  ...
  label1 = new GLabel(gui, 109, 6, 103, 24);
  ...
  heightSlider = new GCustomSlider(gui, 281, 52, 100, 40, "grey_blue");
  ...
  gridButton = new GCheckbox(gui, 259, 199, 120, 21);
  ...
  autoAlign = new GCheckbox(gui, 259, 178, 120, 20);
  ...
  label20 = new GLabel(gui, 9, 6, 80, 20);
