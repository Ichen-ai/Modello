...
public void createGUI(){
  ...
  X_Spacing = new GCustomSlider(ArrGUI, 132, 23, 100, 40, "grey_blue");
  ...
  Y_Spacing = new GCustomSlider(ArrGUI, 132, 51, 100, 40, "grey_blue");
  ...
  SizeSliders = new GLabel(ArrGUI, 132, 92, 123, 20);
  SizeSliders.setText("Size ");
  SizeSliders.setOpaque(false);
  arrwidthslider = new GCustomSlider(ArrGUI, 132, 113, 100, 40, "grey_blue");
  ...
  arrheightslider = new GCustomSlider(ArrGUI, 132, 143, 100, 40, "grey_blue");
