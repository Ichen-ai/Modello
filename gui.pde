...
public void createGUI(){
  ...
  blueSlider = new GCustomSlider(gui, 129, 76, 100, 40, "grey_blue");
  ...
  redSlider = new GCustomSlider(gui, 129, 26, 100, 40, "grey_blue");
  ...
  savetilebutton = new GButton(gui, 12, 189, 80, 30);
  ...
  widthSlider = new GCustomSlider(gui, 281, 26, 100, 40, "grey_blue");
  ...
  heightSlider = new GCustomSlider(gui, 281, 51, 100, 40, "grey_blue");
  ...
  label2 = new GLabel(gui, 235, 6, 80, 20);
  label2.setText("Size Sliders");
  label2.setOpaque(false);
  gridButton = new GCheckbox(gui, 257, 180, 120, 21);
  ...
  clearButton = new GButton(gui, 13, 134, 80, 30);
  clearButton.setText("Clear Tile");
  clearButton.addEventHandler(this, "clearButtonClick");
  autoAlign = new GCheckbox(gui, 257, 156, 120, 20);
  ...
  label3 = new GLabel(gui, 108, 152, 112, 29);
  label3.setText("Background Colour");
  label3.setOpaque(false);
  bgRedSlider = new GCustomSlider(gui, 130, 182, 100, 40, "grey_blue");
  bgRedSlider.setShowValue(true);
  bgRedSlider.setLimits(100, 0, 255);
  ...
  bgGreenSlider = new GCustomSlider(gui, 130, 205, 100, 40, "grey_blue");
  bgGreenSlider.setShowValue(true);
  bgGreenSlider.setLimits(100, 0, 255);
  ...
  bgBlueSlider = new GCustomSlider(gui, 130, 228, 100, 40, "grey_blue");
  bgBlueSlider.setShowValue(true);
  bgBlueSlider.setLimits(100, 0, 255);
  ...
  fwdShapeButton = new GButton(gui, 252, 120, 137, 30);
  ...
  bwkShapeButton = new GButton(gui, 108, 120, 140, 30);
  ...
  label12 = new GLabel(gui, 239, 231, 45, 28);
  label12.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label12.setText("Grid Size");
  label12.setOpaque(false);
  colPickCheckbox = new GCheckbox(gui, 257, 93, 120, 20);
  ...
  label20 = new GLabel(gui, 9, 5, 80, 22);
  label20.setText("Shape Type");
  ...
  pageNum = new GLabel(library, 211, 318, 80, 20);
  ...
  aguiback = new GButton(ArrGUI, 93, 190, 95, 30);
  ...
  ArrangementType = new GLabel(ArrGUI, 9, 2, 125, 20);
  ArrangementType.setText("Arrangement Type");
  ArrangementType.setOpaque(false);
  arrTypedroplist = new GDropList(ArrGUI, 10, 26, 90, 120, 5, 10);
  ...
  X_Spacing = new GCustomSlider(ArrGUI, 166, 22, 100, 40, "grey_blue");
  ...
  Y_Spacing = new GCustomSlider(ArrGUI, 166, 47, 100, 40, "grey_blue");
  ...
  Spacing_Labels = new GLabel(ArrGUI, 139, 2, 80, 20);
  Spacing_Labels.setText("Tile Spacing");
  Spacing_Labels.setOpaque(false);
  SizeSliders = new GLabel(ArrGUI, 143, 91, 123, 20);
  SizeSliders.setText("Tile Size");
  SizeSliders.setOpaque(false);
  arrwidthslider = new GCustomSlider(ArrGUI, 167, 114, 100, 40, "grey_blue");
  ...
  arrheightslider = new GCustomSlider(ArrGUI, 167, 145, 100, 40, "grey_blue");
  ...
  libraryButton2 = new GButton(ArrGUI, 10, 149, 97, 30);
  libraryButton2.setText("Library");
  libraryButton2.addEventHandler(this, "libraryClicked2");
  label13 = new GLabel(ArrGUI, 138, 31, 26, 20);
  label13.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label13.setText("X");
  label13.setOpaque(false);
  label14 = new GLabel(ArrGUI, 138, 56, 26, 20);
  label14.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label14.setText("Y");
  label14.setOpaque(false);
  label15 = new GLabel(ArrGUI, 123, 124, 59, 20);
  label15.setText("Width");
  label15.setOpaque(false);
  label16 = new GLabel(ArrGUI, 123, 154, 60, 20);
  label16.setText("Height");
  label16.setOpaque(false);
  colPick = GWindow.getWindow(this, "Colour Picker", 150, 500, 220, 130, JAVA2D);
  colPick.noLoop();
  colPick.setActionOnClose(G4P.KEEP_OPEN);
  colPick.addDrawHandler(this, "win_draw2");
  colPickRedSlider = new GCustomSlider(colPick, 32, 43, 100, 40, "grey_blue");
  ...
  colPickGreenSlider = new GCustomSlider(colPick, 32, 69, 100, 40, "grey_blue");
  ...
  colPickBlueSlider = new GCustomSlider(colPick, 32, 94, 100, 40, "grey_blue");
  ...
  setShapeCol = new GButton(colPick, 138, 31, 77, 40);
  setShapeCol.setText("Set Shape Colour");
  setShapeCol.addEventHandler(this, "setShapeColClick");
  Colour = new GLabel(colPick, 3, 20, 99, 24);
  Colour.setText("Current Colour");
  Colour.setOpaque(false);
  label17 = new GLabel(colPick, 3, 52, 26, 20);
  label17.setText("R");
  label17.setOpaque(false);
  label18 = new GLabel(colPick, 4, 77, 25, 20);
  label18.setText("G");
  label18.setOpaque(false);
  label19 = new GLabel(colPick, 5, 101, 24, 23);
  label19.setText("B");
  label19.setOpaque(false);
  setBgCol = new GButton(colPick, 138, 77, 77, 44);
  setBgCol.setText("Set Background Colour");
  setBgCol.addEventHandler(this, "setBgColClick");
  pickColourCheckbox = new GCheckbox(colPick, 2, 0, 120, 20);
